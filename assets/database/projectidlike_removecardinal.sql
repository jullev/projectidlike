...
--
-- Host: 127.0.0.1
-- Generation Time: May 19, 2021 at 02:34 AM
...
CREATE TABLE `kerjaan` (
  ...
  `foto_kerjaan` varchar(255) NOT NULL,
...
INSERT INTO `kerjaan` (`idkerjaan`, `judul_kerjaan`, `deskripsi`, `foto_kerjaan`, `tanggal_submit`, `deadline`, `kategori_idkategori`, `kabupaten_idkabupaten`, `harga`, `id_status`) VALUES
(2, 'testing', 'ashajkshkajsh', '', '2021-05-07', '2021-06-03', 2, 3509, 18000, 2),
(4, 'Iklan testing2', 'Deskripsi iklan yang menurutu saya menakik adalah 123456789', '', '2021-05-11', '2021-05-27', 6, 3173, 1900000, 2);

-- --------------------------------------------------------

--
-- Table structure for table `report_kerjaan`
--
...
--
-- Table structure for table `star_point`
--
...
INSERT INTO `user` (`iduser`, `username`, `email`, `password`, `nama_user`, `tanggal_lahir`, `no_hp`, `foto_profil`, `role_idrole`, `jenis_kelamin`) VALUES
...
--
-- Indexes for table `kerjaan`
--
ALTER TABLE `kerjaan`
  ADD PRIMARY KEY (`idkerjaan`);

--
-- Indexes for table `report_kerjaan`
--
...
--
ALTER TABLE `hit`
  MODIFY `idhit` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
