										...
										<tbody>
											...
											foreach (@$dataIklan as $value) { ?>
												<tr>
													...
													<td>
														<div class="d-flex">
															<a href="<?php echo base_url() ?>reportiklanselesai/<?php echo $value->idkerjaan ?>" class="btn btn-primary mr-1" data-tooltip="tooltip" data-placement="top" data-original-title="Detail Laporan">
																<i class="bi bi-file-earmark-medical"></i>
															</a>
															<a href="" class="btn btn-danger" data-tooltip="tooltip" data-placement="top" data-original-title="Tolak">
