				...
				<div class="card-body p-3 bg-light">
					...
					<div class="card mt-2">
						<a href="#avatarCollapse" data-toggle="collapse" role="button" aria-expanded="false"
						   aria-controls="avatarCollapse" class="list-group-item-action">
					...
					<!-- Account Details -->
					<div class="card mt-3">
						<a href="#accountCollapse" data-toggle="collapse" role="button" aria-expanded="false"
						   aria-controls="accountCollapse" class="list-group-item-action">
							<div class="card-header">
								Account Details
							</div>
						</a>
...
<!--											</div>-->
									...
									<div class="form-group row">
										<label for="nama" class="col-lg-3 col-form-label">Nama<sup
									...
									<div class="form-group row">
										<label for="gender" class="col-lg-3 col-form-label">Jenis Kelamin<sup
													style="color: tomato">*</sup></label>
										<div class="col-lg-9">
									...
									<div class="form-group row">
										<label for="email" class="col-lg-3 col-form-label">Email<sup
													style="color: tomato">*</sup></label>
										<div class="col-lg-9">
									...
									<div class="form-group row">
										<label for="birthdate" class="col-lg-3 col-form-label">Tanggal Lahir<sup
													style="color: tomato">*</sup></label>
										<div class="col-lg-9">
									...
									<div class="form-group row">
										<label for="phone" class="col-lg-3 col-form-label">Telepon <sup
													style="color: tomato;">*</sup></label>
									...
									<div class="form-group row">
										<label for="alamat" class="col-lg-3 col-form-label">Alamat<sup
													style="color: tomato">*</sup></label>
										<div class="col-lg-9">
					...
					<!-- Pengaturan -->
					<div class="card mt-3">
						<a href="#settingCollapse" data-toggle="collapse" role="button" aria-expanded="false"
						   aria-controls="settingCollapse" class="list-group-item-action">
							<div class="card-header">
								Pengaturan
							</div>
						</a>
						<div class="collapse show" id="settingCollapse">
							<div class="card-body" style="padding: 45px;">
								...
								<form action="<?php echo site_url('update-password') ?>" method="POST" onsubmit="return pwdValidation()">
									...
									<div class="form-group row">
										<label for="pwdC" class="col-lg-3 col-form-label">Konfirmasi Password<sup
													style="color: tomato">*</sup></label>
										<div class="col-lg-9">
