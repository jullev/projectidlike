				...
				<div class="card">
					...
					<div class="card-body py-5 px-5">
						...
						<form action="C_TambahList/prosesTambah" method="Post">
							...
							<!-- Tipe form -->
							<div class="form-group row">
								<label for="tipe" class="col-md-3 col-form-label">Tipe <sup
											style="color:tomato">*</sup></label>
								<div class="col-md-8 ">
									<div class="form-check form-check-inline pt-2">
										<input class="form-check-input" type="radio" name="tipe" id="private"
											   value="private">
										<label class="form-check-label" for="private">Private</label>
									</div>
									<div class="form-check form-check-inline pt-2">
										<input class="form-check-input" type="radio" name="tipe" id="professional"
											   value="professional">
							...
							<div class="form-group row">
								<label for="email" class="col-md-3 col-form-label">Email<sup
											style="color:tomato">*</sup></label>
								<div class="input-group mb-3 col-md-8">
									<div class="input-group-prepend ">
