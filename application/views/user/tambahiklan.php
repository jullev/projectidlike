							...
							<div class="form-group row">
								...
								<div class="col-md-9">
									<div class="custom-file">
										<input type="file" class="custom-file-input" id="img" name="img" aria-describedby="inputGroupFileAddon01" accept="image/jpeg, image/png">
					...
					<div class="reg-text-box p-3">
						<div class="card">
							...
							<div class="card-body text-left">
								<ul>
									<li><small>Gunakan judul yang singkat dan deskripsi item tersebut</small></li>
