			...
			<div class="col-md-12 col-lg-9 pr-lg-2 mb-2 mb-lg-0">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="<?php echo site_url('search').'?cat='.$dataIklan[0]->kategori_idkategori ?>"><?php echo $dataIklan[0]->nama_kategori ?></a></li>
						...
						<div class="tab-content bg-white p-3" style="border: 1px solid #dee2e6; border-top: none;">
							<div class="row" style="font-size: 120%;">
								<div class="col-12 col-lg-6 text-lg-left text-left">
									...
									<strong>Lokasi: </strong><a href="<?php echo site_url('search').'?loc='.$dataIklan[0]->kabupaten_idkabupaten?>"><?php echo $value->nama_kabupaten; ?></a>
								</div>
							...
							<li class="list-group-item small">
								<div class="row px-2">
									...
									<div class="col-6 p-0 text-right mb-2">
										<a href="<?php echo site_url('search').'?loc='.$dataIklan[0]->kabupaten_idkabupaten?>"><?php echo $value->nama_kabupaten; ?></a>
									</div>
									<!-- Penawaran -->
									<div class="col-1 p-0">
										<i class="bi-tag-fill mr-2"></i>
