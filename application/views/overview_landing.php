					...
					<div class="form-row card mx-auto rounded-pill">
						<div class="col">
							<div class="input-group ml-3 my-2">
								...
								<input class="form-control mr-1" style="border: none !important;" type="text"
									   placeholder="Dimana ?">
								<button type="submit" class="btn btn-primary rounded-pill mr-4"><i
											class="bi-search"></i> Cari!
								</button>
							</div>
						</div>
					</div>
...
<div class="container">
	<section
			style="background: #e9ecef;margin: 10px;padding: 10px;border-style: none;border-radius: 5px;box-shadow: 0px 0px 0px rgb(27,30,33);">
