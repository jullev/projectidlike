...
$route['adminlist'] = 'admin/C_Overview/adminlist';
$route['tambahadmin'] = 'admin/C_Overview/tambahadmin';
$route['updateadmin'] = 'admin/C_Overview/updateDataAdmin';
$route['dashboard'] = 'user/Overview/dashboard';
$route['editadmin/(:any)'] = 'admin/C_Overview/editAdmin/$1';
...
//$route['ajaxsearch'] = 'user/Overview/ajaxsearch';
